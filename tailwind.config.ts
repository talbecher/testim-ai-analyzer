    ...
    extend: {
      ...
      colors: {
        ...
        bug: {
          ...
          muted: "hsl(var(--bug-muted))",
        },
        flaky: {
          DEFAULT: "hsl(var(--flaky))",
          foreground: "hsl(var(--flaky-foreground))",
          muted: "hsl(var(--flaky-muted))",
        },
        environment: {
          DEFAULT: "hsl(var(--environment))",
          foreground: "hsl(var(--environment-foreground))",
          muted: "hsl(var(--environment-muted))",
        },
        expected: {
          DEFAULT: "hsl(var(--expected))",
          foreground: "hsl(var(--expected-foreground))",
          muted: "hsl(var(--expected-muted))",
        },
        // Priority colors
        p0: "hsl(var(--p0))",
        p1: "hsl(var(--p1))",
